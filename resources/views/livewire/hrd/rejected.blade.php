            ...
            <div class="widget-holder col-md-12">
                <div class="widget-bg">
                    <div class="widget-heading widget-heading-border">
                        <h5 class="widget-title" style="display: flex; align-items: center; gap: 0.5rem;">Data Candidate Rejected @livewire('partials.badge-jumlah-proses', ['status' => 'rejected'], key('rejected'))</h5>
                    </div>
