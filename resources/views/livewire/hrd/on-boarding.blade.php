                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><strong>Status:</strong> 
                                <span class="badge badge-{{ $selectedCandidate->status == 'on_boarding' ? 'info' : ($selectedCandidate->status == 'on_boarding' ? 'warning' : 'danger') }}">
...
document.addEventListener('DOMContentLoaded', function() {
    window.addEventListener('showApproveConfirm', function(event) {
        Swal.fire({
            title: 'Konfirmasi',
            text: 'Apakah Anda yakin ingin hire candidate ini?',
            icon: 'warning',
