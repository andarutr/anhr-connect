            ...
            <div class="widget-holder col-md-12">
                <div class="widget-bg">
                    <div class="widget-heading widget-heading-border">
                        <h5 class="widget-title" style="display: flex; align-items: center; gap: 0.5rem;">Data Technical Test @livewire('partials.badge-jumlah-proses', ['status' => 'technical_test'], key('technical_test'))</h5>
                    </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="animate__animated animate__fadeIn">
                                                    ...
                                                    <td>{{ Carbon\Carbon::parse($candidate->date_technical)->format('d/m/y H:i') }}</td>
                                                    <td>{{ $candidate->users->name }}</td>
                                                    <td>
                                                        <a href="{{ $candidate->url_technical }}" target="_blank">{{ Str::limit($candidate->url_technical, 31, '...') }}</a>
                                                    </td>
                                                    <td>
